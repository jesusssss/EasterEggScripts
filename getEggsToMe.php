...
$userId = pget("userId");
$sql = "SELECT * FROM eggLocations LEFT JOIN userInfo ON eggLocations.byUser = userInfo.userId WHERE eggLocations.toUser = '$userId' AND eggLocations.available IS NOT NULL";
